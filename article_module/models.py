...
class Article(models.Model):
    ...
    create_date = models.DateTimeField(auto_now_add=True,editable=False,verbose_name='ثبت تاریخ')
...
class ArticleComment(models.Model):
    article = models.ForeignKey(Article,on_delete=models.CASCADE,verbose_name='کامنت مقاله')
    #'یا کامنت اصلیه یا پاسخشه پس باید پرنت داشته باشه'
    ...
    class Meta:
        ...
        verbose_name_plural = 'کامنت مقالات مقالات'
